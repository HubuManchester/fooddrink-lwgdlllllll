...
public class MockNutritionApi : INutritionApi
{
    private static readonly Dictionary<string, FoodItem> FoodDatabase = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["tea"] = new() { Name = "Green Tea", Category = "Drink", Calories = 1, Protein = 0, Fat = 0, Carbohydrates = 0, Fiber = 0, ServingSize = "100ml" },
        ["tofu"] = new() { Name = "Tofu", Category = "Other", Calories = 76, Protein = 8, Fat = 4.8, Carbohydrates = 1.9, Fiber = 0.3, ServingSize = "100g" },
    };

    private static readonly string[] RecognizedFoods =
    [
        "Apple", "Banana", "Orange", "Chicken Breast", "Broccoli", "Salmon",
        "Noodles", "Pasta", "Tofu", "Cheese Pizza"
    ];

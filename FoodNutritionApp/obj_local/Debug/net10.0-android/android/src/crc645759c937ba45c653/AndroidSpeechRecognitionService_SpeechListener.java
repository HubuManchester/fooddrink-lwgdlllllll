...
public class AndroidSpeechRecognitionService_SpeechListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FoodNutritionApp.Platforms.Android.AndroidSpeechRecognitionService+SpeechListener, FoodNutritionApp", AndroidSpeechRecognitionService_SpeechListener.class, __md_methods);
	}

	public AndroidSpeechRecognitionService_SpeechListener ()
	{
		super ();
		if (getClass () == AndroidSpeechRecognitionService_SpeechListener.class) {
			mono.android.TypeManager.Activate ("FoodNutritionApp.Platforms.Android.AndroidSpeechRecognitionService+SpeechListener, FoodNutritionApp", "", this, new java.lang.Object[] {  });
		}
	}
